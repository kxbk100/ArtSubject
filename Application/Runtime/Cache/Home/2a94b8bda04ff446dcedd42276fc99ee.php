...
<body>
												...
												<fieldset>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<img width="25%" id="verify" class="left15" height="100" alt="验证码" src="<?php echo (C("GOTO")); ?>Home/Index/verify" title="点击刷新" onclick="change()">
														</div>
													</div>
													<!-- /control-group -->
												</fieldset>
	...
	<script>
		...
		function change(){ 
			document.getElementById("verify").src='<?php echo (C("GOTO")); ?>/Home/Index/verify'
		}
	</script>
</body>
</html>