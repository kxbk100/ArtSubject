...
<body>
	...
	<div id="wrapper">
		...
		<div id="content">
			...
			<div class="container">
				<h2 class="text-center">2015届毕业生学生信息</h2>
				<div class="row">
					...
					<div class="col-xs-8 pull-right">
						<button type="button" class="btn btn-primary" style="margin-bottom: 10px;">下载表格</button>
					</div>
				</div>
				<table class="table table-bordered table-striped">
					...
					<tbody>
						<?php if(is_array($result2)): $i = 0; $__LIST__ = $result2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$student): $mod = ($i % 2 );++$i;?><tr>
